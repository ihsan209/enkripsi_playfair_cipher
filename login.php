...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $encrypted_email = playfairEncrypt($email, 'PLAYFAIR');
        ...
        if ($row['email'] === $encrypted_email) {
            ...
            $loginMessage = '<div class="alert alert-danger">Email salah.</div>';
        }
    } else {
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/garage.jpg" alt="sing up image"></figure>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form">
                            ...
                            <div class="form-group position-relative">
                                <input type="text" name="your_email" id="your_email" placeholder="Email" class="form-control">
                            </div>
